...
```json
{
  ...
  "services": [
    {
      "iid": 2,
      "type": "urn:miot-spec-v2:service:vacuum:00007810:roborock-m1s:1",
      "description": "Robot Cleaner",
      "properties": [
        {
          "iid": 1,
          "type": "urn:miot-spec-v2:property:mode:00000008:roborock-m1s:1",
          "description": "Mode",
          "format": "uint8",
          "access": [
            "read",
        ...
        {
          "iid": 2,
          "type": "urn:miot-spec-v2:property:room-ids:00000073:roborock-m1s:1",
        ...
        {
          "iid": 3,
          "type": "urn:miot-spec-v2:property:status:00000007:roborock-m1s:2",
          "description": "Status",
          "format": "uint8",
          "access": [
            "read",
      ...
      "actions": [
        {
          "iid": 1,
          "type": "urn:miot-spec-v2:action:start-sweep:00002804:roborock-m1s:1",
        ...
        {
          "iid": 2,
          "type": "urn:miot-spec-v2:action:stop-sweeping:00002805:roborock-m1s:1",
        ...
        {
          "iid": 3,
          "type": "urn:miot-spec-v2:action:start-room-sweep:00002826:roborock-m1s:1",
    ...
    {
      "iid": 3,
      "type": "urn:miot-spec-v2:service:identify:0000782C:roborock-m1s:1",
      "description": "Identify",
      "actions": [
        {
          "iid": 1,
          "type": "urn:miot-spec-v2:action:identify:00002801:roborock-m1s:1",
          "description": "Identify",
          "in": [],
          "out": []
        }
...
services sub iid is siid
         sub properties sub iid is piid
